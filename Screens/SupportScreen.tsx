        ...
        <View style={{flex: 1, alignItems: "center",justifyContent: "center", padding: 10}}>
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
            <View style={additionalStyles.outerBox}>
              <Text style={{    fontFamily: "Montserrat",fontWeight: '300', fontSize: 25, }}>813-955-3308</Text>
            </View>
            <Button style={additionalStyles.outerBox} onPress={handlePress} text={"Join Our Zoom!"} textStyle={{fontFamily: "Montserrat", fontWeight: '350', fontSize: 25, color: colors.black}}/>
          </View>
          <Image
